...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show("You're now registered and can login", { cssClass: 'alert-success', timeout: 3000 });
...
var AuthService = (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post('users/register', user, headers).map(function (res) { return res.json(); });
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('users/authenticate', user, headers).map(function (res) { return res.json(); });
    };
...
module.exports = "<div class=\"jumbotron text-center\">\n\t<h1>MEAN Authentication App</h1>\n\t<p class=\"lead\">Welcome to our custom MEAN authentication app built from scratch</p>\n\t<div>\n\t\t<a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n\t\t<a class=\"btn btn-default\" [routerLink]=\"['/login']\">Login</a>\n\t</div>\n</div>\n\n\n<div class=\"row\">\n\t<div class=\"col-md-4\">\n\t\t<h3>Express Backend</h3>\n\t\t<p>A rock solid Node.js/Express server using Mongoose to organize models and query the databases</p>\n\t</div>\n\n\t<div class=\"col-md-4\">\n\t\t<h3>Angular CLI</h3>\n\t\t<p>Angular-CLI to to generate components, services and more. Local dev server and easy</p>\n\t</div>\n\n\t<div class=\"col-md-4\">\n\t\t<h3>JWT Tokens</h3>\n\t\t<p>Full featured authentication using JSON web tokens. Login and store user data</p>\n\t</div>\n</div>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show("Invalid User/Password Combination", {
